...
const order = ['js/state.js', 'js/db.js', 'js/media.js', 'js/perf.js', 'js/audioextract.js', 'js/gifencoder.js', 'js/reverse.js', 'js/pro.js', 'js/tutorial.js', 'js/curves.js', 'js/engine.js', 'js/exporter.js', 'js/timeline.js', 'js/app.js'];
